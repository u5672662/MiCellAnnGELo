...
namespace UnityVolumeRendering
{
    ...
    /// <summary>
    /// Importer for image sequence datasets.
    ...
    public interface IImageSequenceImporter
    {
        ...
        /// Each series should be imported separately, resulting in one dataset per series.
        /// <br/>
        /// Note: This will block the main thread until done. You may want to use <see cref="LoadSeriesAsync"/> instead.
        /// </summary>
        /// <param name="files">Files to load. Typically all the files stored in a specific directory.</param>
