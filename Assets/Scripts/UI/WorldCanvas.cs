...
{
    /// <summary>
    /// Maintains player name tags in world space and updates their positions and voice indicators.
    /// </summary>
    public class WorldCanvas : MonoBehaviour
    {
        ...
        private void OnConnectedUpdate(bool connected)
        {
            if (!connected)
            {
        ...
        private bool RemovePlayerNameTag(ulong playerId)
        {
